...
const cmd = proxyquire('../lib/commands/draft', {
        ...
        log: function (params, cb) {
          const commits = {
              ...
              author_email: 'behemoth89@gmail.com' },
            {
              ...
              message: 'Fix ignoreTrailingSlash example (#1574)',
              refs: '',
              body: '',
...
test('draft a version forced release', async t => {
  ...
  opts.path = require('path').join(__dirname, 'fake-project/')
  opts.semver = 'major'
...
test('draft a suggested release') // TODO

test('draft the first release') // TODO
